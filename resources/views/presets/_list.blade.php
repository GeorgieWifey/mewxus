        ...
        <div class="pt-2 border-t border-latte-surface0 flex items-center justify-between gap-1">
          ...
          <div class="flex items-center gap-1">
            ...
            <button type="button"
                    ...
                    hx-confirm="Are you sure you want to delete '{{ $preset->name }}'?"
                    title="Delete Preset"
                    class="pixel-btn text-[10px] px-2 py-1 bg-latte-red text-latte-base hover:opacity-90 border-2 border-latte-text shadow-[2px_2px_0_0_#4c4f69]">
              🗑
            </button>
          </div>
        </div>
